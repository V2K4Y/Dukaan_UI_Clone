export default function TopBar() {
    return (
        <div className="grid grid-cols-3 border-b border-gray-300 p-3 px-8">
            ...
            <div className="flex items-center rounded-md">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="w-10 h-10  bg-gray-100 text-gray-500 p-3 rounded-l-md">
                    <path stroke-linecap="round" stroke-linejoin="round" d="m21 21-5.197-5.197m0 0A7.5 7.5 0 1 0 5.196 5.196a7.5 7.5 0 0 0 10.607 10.607Z" />
                </svg>
                <input className="w-4/5 h-10 bg-gray-100 outline-none rounded-r-md" type="text" placeholder="Search features, tutorials, etc." />
            </div>
